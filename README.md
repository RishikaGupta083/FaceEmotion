This project uses TensorFlow.js and Face-api.js to perform emotion recognition from webcam input in real-time. It runs a simple web application that detects emotions from faces.
